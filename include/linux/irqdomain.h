...
static inline struct irq_domain *irq_domain_add_linear(struct device_node *of_node,
					 ...
					 void *host_data)
{
	return __irq_domain_add(of_node_to_fwnode(of_node), size, size, 0, ops, host_data, NULL);
}
...
static inline struct irq_domain *irq_domain_add_nomap(struct device_node *of_node,
					 ...
					 void *host_data)
{
	return __irq_domain_add(of_node_to_fwnode(of_node), 0, max_irq, max_irq, ops, host_data, NULL);
}
