...
static struct resource bd96801_wdg_irq;
...
static int bd96801_i2c_probe(struct i2c_client *i2c)
{
	...
	wdg_irq = irq_create_mapping(intb_domain, BD96801_WDT_ERR_STAT);
	bd96801_wdg_irq = DEFINE_RES_IRQ_NAMED(wdg_irq, "bd96801-wdg");
