...
static int bd71828_i2c_probe(struct i2c_client *i2c)
{
	...
	case ROHM_CHIP_TYPE_BD72720:
	{
		...
		for (i = 0; i < cells; i++)
			if (!strcmp(BD72720_POWER_DRV_NAME,
				    bd72720_mfd_cells[i].name))
				break;
		WARN_ON(i >= cells);
		bd72720_mfd_cells[i].platform_data = &bd72720_chg_regmap;
		bd72720_mfd_cells[i].pdata_size = sizeof(bd72720_chg_regmap);
