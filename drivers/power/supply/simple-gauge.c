...
static int compute_soc_by_cc(struct simple_gauge *sw, int state)
{
	...
	/*
	 * Some ICs may have temperature correction which is not utilizing
	 * set of OCV 0 => CAP tables for different temperatures. Allow them
	 * to provide custom temp compensation routine
	 */
