...
/**
 * power_supply_batinfo_ocv2dcap - compute ocv based on SOC and temperature
 * @info:	pointer to battery information
 * @ocv:	Open circuit voltage in uV
 * @temp:	Temperature in Celsius
 *
 * Use OCV tables in battery info to compute the open circuit voltage at
 * given capacity and temperature.
 *
 * Return: 0 at succes, -EINVAL if OCV table is not present.
 */
