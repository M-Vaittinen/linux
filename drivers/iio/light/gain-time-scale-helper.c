 ...
 * @scale_int:	Pointer tontegral part of the scale (typically val1)
				...
				int *scale_int, int *scale_nano)
{
	...
	return iio_gts_delinearize(tmp, scale_int, scale_nano, NANO);
}
				...
				int scale_nano, int *gain_tot)
{
	...
	ret = iio_gts_linearize(scale_int, scale_nano, &lin_scale, NANO);
	if (ret)
		return ret;
