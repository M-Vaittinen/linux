...
static int bd71815_gpio_set_config(struct gpio_regmap *g, unsigned int offset,
				   unsigned long config)
{
	struct bd71815_gpio *bdgpio;
	struct regmap *regmap;

	bdgpio = gpio_regmap_get_drvdata(g);
	regmap = gpio_regmap_get_regmap(g);
 ...
 */
static int bd71815_init_valid_mask(struct gpio_regmap *g,
